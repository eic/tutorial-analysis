# Analyzing EIC Simulation Output
...
An ePIC tutorial that shows how to locate, explore, and analyze the reconstructed simulation output
produced by EICrecon, using ROOT, Python/uproot, RDataFrame, and PODIO based approaches.
...
* Stephen Kay, @sjdkay, stephen.kay@york.ac.uk
